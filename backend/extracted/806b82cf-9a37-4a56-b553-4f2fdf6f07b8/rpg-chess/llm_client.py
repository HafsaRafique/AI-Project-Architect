...
# Both configurable via environment variables so the same code runs
# unchanged whether Ollama is on localhost, in a sibling Docker container
# (e.g. "http://ollama:11434"), or on a remote GPU box.
